  ...
  <div class="antialiased">
    ...
    >
      <div class="flex flex-wrap justify-between items-center">
        <div class="flex justify-start items-center">
          ...
          <RouterLink to="/" class="flex items-center justify-between mr-4 hover:bg-transparent">
            <!-- <img
    ...
    >
      <div class="overflow-y-auto py-5 px-3 h-full bg-white dark:bg-gray-800">
        ...
        <workspaceSelector
          :current-workspace-name="currentWorkspace.name"
          :current-workspace-id="currentWorkspace.workspaceId"
